...
function MSM_PredTimeseries(timeseries::S,
    ...
    MSM_PredTimeseries(S, num_preds, params(timeseries),
...
MSM_PredTimeseries(::Type{MSM_Timeseries_Point{T}},
    num_preds, num_params, num_layers, timeSteps) where T <: Real =
    MSM_Timeseries_Point{T}(num_preds, num_params, num_layers, timeSteps)
